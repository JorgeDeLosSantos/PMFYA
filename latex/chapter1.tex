\chapter{Fundamentos del lenguaje}\label{fundamentos-del-lenguaje}

\section{¿Qué es MATLAB?}\label{que-es-matlab}
...
\section{Descripción del entorno de desarrollo}\label{descripcion-del-entorno-de-desarrollo}
...
\begin{figure}[htbp]
  ...
  \caption{Pantalla de MATLAB R2012b}
  \label{fig:screen_2012b}
\end{figure}

\section{Comandos básicos y generalidades}\label{comandos-basicos-y-generalidades}

\subsection{Consultar ayuda de MATLAB}\label{consultar-ayuda-de-matlab}
...
\subsection{Limpiar ventana de comandos y variables del workspace}\label{limpiar-ventana-de-comandos-y-variables-del-workspace}
...
\subsection{Líneas de comentarios}\label{luxedneas-de-comentarios}
...
\section{Tipos de datos y operadores}\label{tipos-de-datos-y-operadores}
...
\subsection{Tipo logical}\label{tipo-logical}
...
un valor \texttt{true} (1 lógico).

\subsection{Tipo char}\label{tipo-char}
...
\subsection{Tipo numeric}\label{tipo-numeric}
...
\subsection{Tipo cell}\label{tipo-cell}
...
\subsection{Identificar tipos de datos}\label{identificar-tipos-de-datos}
...
\subsection{Conversiones entre tipos de datos}\label{conversiones-entre-tipos-de-datos}
...
\subsubsection{Entre tipos numéricos}\label{entre-tipos-numericos}
...
\subsubsection{De string a tipo numérico} \label{de-string-a-tipo-numuxe9rico}
...
\subsection{Operadores aritméticos, relacionales y lógicos}\label{operadores-aritmeticos-relacionales-y-logicos}
...
(operandos), se pueden clasificar en tres grupos:
...
\section{Un mini tutorial de
introducción}\label{un-mini-tutorial-de-introduccion}
...
\begin{figure}[htbp]
  ...
  \caption{Gráfica de una función $f(x,y)$}
  \label{fig:xxxx}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{images/ch1/lena.png}
  \caption{Lena}
  \label{fig:lena}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.5\textwidth]{images/ch1/lena_mod.png}
  \caption{Lena modificada}
  \label{fig:lena_mod}
\end{figure}
...
\section{Ficheros de comandos (scripts)}\label{ficheros-de-comandos-scripts}
...
\section{Bifurcaciones y bucles}\label{bifurcaciones-y-bucles}

\subsection{Sentencia if-elseif-else}\label{sentencia-if-elseif-else}
...
\section{Fecha y hora}\label{fecha-y-hora}
...
\begin{ejemplo}{Ejemplo 1.1 Clasificando flujos}
...
utilizar una bifurcación múltiple \texttt{if-elseif-else}. \footnote{Danilo
